...
MODEL_FILE = PROCESSED_DIR / "cnn_arrhythmia_model.keras"
...
def main():
    print("[STEP 1] Loading CNN dataset...")
    X = np.load(X_FILE)
    ...
    print("[INFO] Train groups:", len(set(groups[train_idx])))
    print("[INFO] Test groups:", len(set(groups[test_idx])))
    ...
    report_path = PROCESSED_DIR / "cnn_classification_report.txt"
