...
def main():
    ...
    print("[STEP 2] Applying SMOTE on train set...")
    smote = SMOTE(random_state=42, k_neighbors=3)
    X_train_resampled, y_train_resampled = smote.fit_resample(X_train, y_train)

    print(f"[INFO] Train after SMOTE: {X_train_resampled.shape}")
    print("[INFO] Resampled class distribution:")
    ...
    out_file = PROJECT_ROOT / "data" / "processed" / "real_arrhythmia_feature_importance_smote.csv"
