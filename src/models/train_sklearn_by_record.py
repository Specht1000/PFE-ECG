...
def train_random_forest_by_record(
    train_file: Path = None,
    test_file: Path = None,
    model_name: str = "random_forest_rr_by_record.pkl"
) -> Path:
    ensure_directories()

    if train_file is None:
        train_file = PROCESSED_DIR / "rr_train.csv"

    if test_file is None:
        test_file = PROCESSED_DIR / "rr_test.csv"
